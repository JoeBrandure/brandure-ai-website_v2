  ...
  return (
    <section id="journey" className="section-snap" style={{ 
      ...
      <div className="content-wrapper">
        <h2 className="section-heading-medium brandure-animate-white" style={{ lineHeight: 1.3, marginBottom: '40px' }}>
          We spend our days guiding companies<br />
          through our 3-step <span className="brandure-animate-blue">AI-Transformation</span> process
        </h2>
